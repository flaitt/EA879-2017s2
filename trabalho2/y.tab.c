...
{
  "$end", "error", "$undefined", "STRING", "BRILHO", "VAR", "IGUAL",
  "EOL", "ASPA", "AST", "BARRA", "NUM", "SOMA", "$accept", "PROGRAMA",
...
{
       2,     9,    10,     3,     4,     6,     8,    11,     7,    12
};

static const yytype_uint8 yycheck[] =
{
       0,     9,    10,     3,     4,     6,     3,    11,     7,    11
};
...
#line 37 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
       ...
       /* printf("antes de multiplicar\n");*/
        multiplicaBrilho((yyvsp[0].fval),&I);
...
#line 63 "./src/imageprocessing.y" /* yacc.c:1906  */
